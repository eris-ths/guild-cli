...
//      the bin entries — see gate.mjs for the rationale. Classification
...
const ENTRY_URL = new URL('../dist/src/passages/delta/interface/index.js', import.meta.url).href;
