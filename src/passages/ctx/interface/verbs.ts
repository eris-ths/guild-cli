...
// content_root); and the read-side `list` / `show` / `chain`. Phase 2 will
// still add fork / status.

export const READ_VERBS: ReadonlySet<string> = new Set(['export', 'list', 'show', 'chain']);
